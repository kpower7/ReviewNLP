...
# File path
file_path = r"C:\Users\k_pow\OneDrive\Documents\MIT\MITx SCM\Spring 2025\SCM256\Project\low_ratings.csv"

# Load dataset
df = pd.read_csv(file_path)

# Sample 30000 reviews for testing
...
output_df.to_csv("sampled_classified_reviews.csv", index=False)

print("Classification complete! Results saved to 'sampled_classified_reviews.csv'.")
