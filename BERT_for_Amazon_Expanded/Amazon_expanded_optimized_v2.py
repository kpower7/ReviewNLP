...
#checkpoint_dir = '/home/gridsan/kpower/BERT_for_Amazon_Expanded/daily_trained/finetuned_model/checkpoint-187305'
...
# Load your model from the checkpoint
...
trainer.save_model(training_args.output_dir)  # includes model weights
trainer.save_state()                          # includes optimizer/scheduler/training state
print(f"Saved full checkpoint to {training_args.output_dir}")
